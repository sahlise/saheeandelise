  ...
  return (
    <div className="bg-white">
      ...
      <div className="w-full flex justify-center">
        <div className="bg-weddingGreen m-5 p-1 rounded-lg md:w-2/3">
          <div className="flex flex-col justify-center items-center">
            <h1 className="text-white text-3xl md:text-5xl text-center">A Couple of</h1>
            <h1 className="text-white text-3xl md:text-5xl text-center">Couple Quirks</h1>
          </div>
      ...
      <div className="hidden md:block">
        <div className="text-4xl flex justify-center items-center bg-weddingGreen rounded-lg mx-3">
        ...
        <div className="grid grid-cols-2 gap-2">
          ...
          <div>
            <div className="text-2xl pt-5">Elise&apos;s Point of View</div>
            <p className="pr-5 py-2">I walked into my first day of my first Computer Science class at UW La-Crosse with the goal of finding some friends in the same major as me. I got to class a little early, sat down, and waited for someone to sit by me to initiate conversation. However, that day, no one talked to me, and I remember feeling like I had made a mistake in the major that I chose, that I was over my head.</p>
            <p className="pr-5 py-2">I walked into the second day of class with this weight on my shoulders, when I saw someone sitting in the seat next to the one that I had been sitting in the class before. I quickly sat down, introduced myself, and then started to get to know my new Computer Science friend.</p>
            <p className="pr-5 py-2">Class after class, we continued to talk before and after, learning about each other&apos;s lives little by little. My biggest problem was that I couldn&apos;t remember the person&apos;s name and felt too awkward to ask for it again. Luckily, after working on a class project, I stealthily found out that my CS friend&apos;s name was Sahee 🙂. After a few months, Sahee and I were basically inseparable.</p>
          </div>
          <div>
            <div className="text-2xl text-end">Sahee&apos;s Point of View</div>
            <p className="ml-5 text-left text-end">On the first day of my intro CS class, I decided to sit in the second row because I didn&apos;t want to sit in the front but didn&apos;t want to sit in the back. It was a good day of class. On the second day, I sat in the same spot. But someone (hint: Elise) came to sit in the seat next to me. We talked and established each other as amicable teammates for future class projects. Somewhere along the way, homework turned into dinner, and dinner turned into a date. All in all, she is the best classmate you could ever ask for.</p>
          </div>
          <div className="flex justify-center items-center my-5">
            <div className="w-1/2">
              <figure>
      ...
      {/* First date */}
      <div className="m-5 bg-lime-100 rounded-lg md:w-2/4">
      ...
      <div className="mx-5 mt-5 bg-lime-100 rounded-t-lg">
        ...
        <div className="hidden md:block">
          <div className="grid grid-cols-2 gap-2">
            <div>
              <p className="pl-5 py-3">After graduating from college, we set off on a Wisconsin road trip, exploring quirky roadside attractions and scouring antique stores for Elise&apos;s perfect engagement ring design. By the end of the trip we knew what we were looking for, and picked out an engagement ring together. Click through on the right to see photos of the road trip!</p>
            </div>
            <div>
        ...
        <div className="block md:hidden">
          <p className="px-3 py-3">After graduating from college, we set off on a Wisconsin road trip, exploring quirky roadside attractions and scouring antique stores for Elise&apos;s perfect engagement ring design. By the end of the trip we knew what we were looking for, and picked out an engagement ring together. Here are some photos of the road trip!</p>
